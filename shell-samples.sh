...
m_uli () {
    ...
    local CMD="ssh \\
        ...
        -p 32222 \\
        $PROJECT-$ENVIRONMENT@ssh.client.cloud 'drush user:login --mail=$MAIL'
        "
...
EOF
    ...
    local CMD="ssh \\
        ...
        -o LogLevel=FATAL \\
        -p 32222 \\
        $PROJECT-$ENVIRONMENT@ssh.client.cloud < $SCRIPT
        "
